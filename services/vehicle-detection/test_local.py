# services/vehicle-detection/test_local.py
import cv2
from app.model import VehicleDetector   # <-- changed

detector = VehicleDetector()             # <-- changed

cap = cv2.VideoCapture("test_video.mp4")   # you'll point this at a traffic video
if not cap.isOpened():
